...
/** BEGIN Adding content JavaScript from dropdown-menu.js **/
...
function prepareMenu() {
    ...
    if (!document.getElementById("navTop")) return false;
...
/** END Adding content JavaScript from dropdown-menu.js **/